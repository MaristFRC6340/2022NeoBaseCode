...
public class Red3Command extends SequentialCommandGroup {
    
    public Red3Command(DriveTrain driveTrain, Intake intake, Indexer indexer, Shooter shooter) {
        ...
        addCommands(
          ...
          new ShootTimeCommand(shooter, intake, indexer, 0.5, 2.7)
        );
      }
}
